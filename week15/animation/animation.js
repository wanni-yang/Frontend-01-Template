    ...
    constructor(){
        ...
        this.tick = ()=>{
            ...
            for(let animation of this.animations){
                ...
                let {object, property,template, timingFunction, delay, duration, addTime} = animation;
                ...
                // let currentValue = start + progression * (end - start); // 根据progression算出来的当前值
                let currentValue = animation.valueFromProgression(progression)
